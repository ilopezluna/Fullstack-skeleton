...
//              }
    ...
    .directive('sushiRate', function() {
        return {
            templateUrl: 'templates/directives/sushi-rating.html'
        };
    })
    .directive('sushiHelper', function() {
        return {
            restrict: 'AE',
            scope: {
                sushiHelper: '=message'
            },
            templateUrl: 'templates/directives/sushi-helper.html'
